                                ...
                                $.post(url, data, function (respon) {
                                    ...
                                    if (typeof respon === 'object') {
                                        ...
                                        setTimeout(function () {
                                           ...
                                           if (mobileInput) { mobileInput.value = respon.user.mobile; }
                                           var mobileInputs = document.getElementsByName("mobile");
                                           for (var i = 0; i < mobileInputs.length; i++) { mobileInputs[i].value = respon.user.mobile; }
                                        }, reloadTime);
                                    }
                                ...
                                if (respon.force_redirect) {
                                    ...
                                    if (respon.redirect) {
                                       ...
                                       if (respon.user) {
                                            ...
                                            var mobileInput = document.getElementById("mobile_code");
                                            if (mobileInput) { mobileInput.value = respon.user[0].mobile; }
                                            var mobileInputs = document.getElementsByName("mobile");
                                            for (var i = 0; i < mobileInputs.length; i++) { mobileInputs[i].value = respon.user[0].mobile; }
