...
SELECT DISTINCT  
     ...
     i.id AS image_id, i.ads_image, i.id_description,
     a.id AS ads_id, a.title, a.timeAdded, a.timeUpdated, a.time_update_ad, a.views, a.id_special, a.id_category, a.id_user, a.id_description,
