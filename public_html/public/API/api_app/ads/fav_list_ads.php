...
SELECT DISTINCT  
     ...
     u.id, u.username, u.phone, u.email, u.timeRegistered, u.lastActive, u.verified, u.about, u.image, f.isFav
...
INNER JOIN favourite AS f
           ON f.id_ads = a.id_description
           AND f.phone_faved_user = '".$phone."';
");
