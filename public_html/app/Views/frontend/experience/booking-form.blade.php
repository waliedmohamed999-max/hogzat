                ...
                <label class="d-block mb-2" style="border-bottom: 1px solid #EEE;padding-bottom: 14px;">
                    {{__('Summary')}}
                        ...
                        <div class="extra-item d-flex">
                            ...
                            <span
                                class="price ml-auto">{{$Commission }}% ({{number_format((($basePrice*$Commission)/100),2,",",".") }} ريال ) </span>
                        </div>
                                           <div class="extra-item d-flex">
                            <span
                                class="name">{{__('Tax')}} <span> القيمة المضافة (vat)</span></span>
                            <span
                                class="price ml-auto">{{ $tax_value }}% ({{ number_format(((($basePrice+($basePrice*$Commission)/100)*$tax_value)/100),2,",",".")}} ريال ) </span>
                        </div>
                            ...
                            <span
                                class="price ml-auto">{{ number_format($total_amount,2,",",".")}} ريال</span>
                        </div>
