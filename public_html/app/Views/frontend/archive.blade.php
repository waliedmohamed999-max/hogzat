...
if (isset($term)) {
    ...
    if ($term_obj != null) {
        $page_title =
        // $page_title . ': ' .
        get_translate($term_obj->term_title);
    }
}
                ...
                <div class="page-content">
                    ...
                    @if(isset($term) && !is_null($term_obj))
                        <p class="term-description">
                            @if ($term_obj->term_name == 'mn-nhn')
                            <?php echo balanceTags(get_translate($term_obj->term_description)); ?>
                            @else
                    ...
                    <!--        <div class="col-md-2">-->
                    <!--             <img style="width: 100%"  class="loaded" src="{{asset('images/1.jpeg')}}">-->
                    <!--        </div>-->
                    <!--        <div class="col-md-2">-->
                    <!--             <img style="width: 100%"  class="loaded" src="{{asset('images/2.jpeg')}}">-->
                    <!--        </div>-->
                    <!--        <div class="col-md-2">-->
                    <!--             <img style="width: 100%"  class="loaded" src="{{asset('images/3.jpeg')}}">-->
                    <!--        </div>-->
                     
                    <!--        <div class="col-md-2">-->
                    <!--             <img style="width: 100%"  class="loaded" src="{{asset('images/4.jpeg')}}">-->
                    <!--        </div>-->
                    <!--        <div class="col-md-2">-->
                    <!--             <img style="width: 100%"  class="loaded" src="{{asset('images/5.jpeg')}}">-->
                    <!--        </div>-->
                    <!--        <div class="col-md-2">-->
                    <!--             <img style="width: 100%"  class="loaded" src="{{asset('images/6.jpeg')}}">-->
                    <!--        </div>-->
                    <!--    </div>-->
