    ...
    <ul class="menu cart-list">
        ...
        ?>
         <li class="divider">
            ...
            <span>{{$Commission }}% ({{number_format(($basePrice*$Commission)/100,2,",",".")}} ريال)</span>
        </li>
        <li class="divider">
            <span>{{__('Tax')}}
            ...
            <span>{{ $tax_value }}% ({{number_format((($basePrice+($basePrice*$Commission)/100)*$tax_value)/100,2,",",".")}} ريال )</span>
        </li>
