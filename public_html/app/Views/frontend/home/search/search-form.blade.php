<div class="labayh-search-heading">
    <span class="labayh-kicker">Labayh</span>
    <h1 class="h3">{{ __('Book unique places to stay') }}</h1>
    <p>{{ __('Search faster, compare better, and book with more confidence.') }}</p>
</div>
<form action="{{ get_home_search_page() }}" class="form mt-3 labayh-search-form" method="get">
    ...
    <div class="form-group form-group-booking-type">
    ...
    <div class="form-group form-group-date form-group-date-range">
    ...
    <div class="form-group form-group-submit">
        <input class="btn btn-primary w-100 labayh-search-submit" type="submit" name="sm"
               value="{{__('Search')}}">
    </div>
</form>
