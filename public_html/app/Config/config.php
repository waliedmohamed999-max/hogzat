...
return [
    ...
    'admin_menu' => [
        ...
        [
            'type' => 'item',
            'label' => awe_lang('Labayh Frontend'),
            'icon' => '005_website',
            'screen' => 'premium-frontend',
        ],
        [
            'type' => 'item',
        ...
        [
            ...
            'child' => [
                [
                    ...
                    'screen' => 'services/homes/new',
                ],
                [
                    'type' => 'item',
                    'label' => awe_lang('My Homes'),
                    'screen' => 'services/homes',
                ],
                [
                    'type' => 'hidden',
                  ...
                  [
                    ...
                    'screen' => 'services/homes/last-minute',
                ],
                
                [
                    'type' => 'item',
                    'label' => awe_lang('Reviews'),
                    'screen' => 'services/homes/reviews',
                ],
                [
                    'type' => 'item',
                    'label' => awe_lang('Types'),
                    'screen' => 'services/homes/types',
                ],
                [
                    'type' => 'item',
                    'label' => awe_lang('Amenities'),
                    'screen' => 'services/homes/amenities',
                ],
            ],
            'screen' => ['services/homes/new', 'services/homes', 'services/homes', 'services/homes/reviews', 'services/homes/types', 'services/homes/amenities']
        ],
        [
            'type' => 'parent',
            ...
            'child' => [
                [
                    ...
                    'screen' => 'services/experiences/new',
                ],
                [
                    'type' => 'item',
                    'label' => awe_lang('My Experiences'),
                    'screen' => 'services/experiences',
                ],
                [
                    'type' => 'hidden',
                ...
                [
                    'type' => 'item',
                    'label' => awe_lang('Reviews'),
                    'screen' => 'services/experiences/reviews',
                ],
                [
                    'type' => 'item',
                    'label' => awe_lang('Types'),
                    'screen' => 'services/experiences/types',
                ],
                [
                    'type' => 'item',
                    'label' => awe_lang('Languages'),
                    'screen' => 'services/experiences/languages',
                ],
                [
                    'type' => 'item',
                    'label' => awe_lang('Inclusions'),
                    'screen' => 'services/experiences/inclusions',
                ],
                [
                    'type' => 'item',
                    'label' => awe_lang('Exclusions'),
                    'screen' => 'services/experiences/exclusions',
                ],
            ],
            'screen' => ['services/experiences/new', 'services/experiences', 'services/experiences', 'services/experiences/reviews', 'services/experiences/types', 'services/experiences/languages', 'services/experiences/inclusions', 'services/experiences/exclusions']
        ],
        // [
        //     'type' => 'parent',
        //     'label' => awe_lang('Car'),
        ...
        //         ],
        //     ],
        //     'screen' => ['', '', '', '', 'get-terms/car-type', 'get-terms/car-equipment', 'get-terms/car-feature']
        // ],
        [
            'type' => 'heading',
    ...
    'partner_menu' => [
        ...
        [
            ...
            'screen' => ['services/homes/new', 'services/homes', 'services/homes', 'services/homes/reviews']
        ],
        [
            'type' => 'parent',
            'label' => awe_lang('Experiences'),
            ...
            'screen' => ['services/experiences/new', 'services/experiences', 'services/experiences', 'services/experiences/reviews']
        ],
        // [
        //     'type' => 'parent',
        //     'label' => awe_lang('Car'),
