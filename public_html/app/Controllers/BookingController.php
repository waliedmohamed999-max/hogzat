...
class BookingController extends Controller
{
    public function createBooking($user_id)
    {
	    ...
	    if(request()->nemo!=null){
        $filename = time().'.'.request()->nemo->getClientOriginalExtension();
        request()->nemo->move(public_path('images'), $filename);}
    ...
    public function updateBookingStatus($booking_id, $status, $created_booking = false)
    {
        ...
        EarningController::get_inst()->updateEarning($booking_id,$has->service_type);
