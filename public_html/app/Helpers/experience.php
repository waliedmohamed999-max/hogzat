...
function count_sub($experience_id)
{
     $Participants = App\Models\Participants::where('experienceID', $experience_id)->get();
...
function get_experience_by_id($experience_id)
{
     $experience_object = new Experience();
        return $experience_object->getById($experience_id);
}
